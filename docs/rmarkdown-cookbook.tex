...
\date{2021/03/28 12:06:22 JST, ver. 0.9 (一部未校正), 本家の更新確認時刻: \href{https://github.com/yihui/rmarkdown-cookbook}{2021/03/21 16:15:28 JST}}
...
自分で用例集に挑戦したいならば, 本書の完全なソースコードと用例集は Github の \url{https://github.com/yihui/rmarkdown-cookbook} で自由に見ることができます\footnote{訳注: この日本語版のソースコードは \url{https://github.com/Gedevan-Aleksizde/rmarkdown-cookbook} で見られます. 用例集はさらに \texttt{JP/examples} と辿ることで見つかります.}. 本書の電子書籍版をお読みの場合, 掲載されているコードをお好きなテキストエディタにコピー\&ペーストして実行することになるでしょう.
...
\chapter*{翻訳者情報}\label{translators}}
\addcontentsline{toc}{chapter}{翻訳者情報}
