...
\date{2021/09/15 14:25:50 JST, ver. 1.0.0, 本家の更新確認時刻: \href{https://github.com/yihui/rmarkdown-cookbook}{2021/08/17 19:34:48 JST}}
...
\NormalTok{    Report Generation in R\},}
  \DataTypeTok{author}\NormalTok{ = \{Yihui Xie\},}
  \DataTypeTok{year}\NormalTok{ = \{2021\},}
  \DataTypeTok{note}\NormalTok{ = \{R package version 1.34\},}
...
\begin{Highlighting}[]
\NormalTok{{-}{-}{-}}
\NormalTok{output: pdf\_document}
\NormalTok{{-}{-}{-}}

\NormalTok{薔薇は \textbackslash{}textcolor\{red\}\{赤い\}, 菫は \textbackslash{}textcolor\{blue\}\{青い\}.}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{processing file: myfile.Rmd}
\NormalTok{Error in parse\_block(g[{-}1], g[1], params.src, markdown\_mode) :}
\NormalTok{  Duplicate chunk label \textquotesingle{}cars\textquotesingle{}}
\NormalTok{Calls: \textless{}Anonymous\textgreater{} ... process\_file {-}\textgreater{} split\_file {-}\textgreater{} lapply {-}\textgreater{}}
\NormalTok{  FUN {-}\textgreater{} parse\_block}
\NormalTok{Execution halted}
\end{Highlighting}
\end{Shaded}
