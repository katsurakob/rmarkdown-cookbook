...
<div class="figure" style="text-align: center">
<img src="JP/images/trackdown1.png" alt="trackdown の作業工程, コードの共同執筆は Git を使いローカルで行い,  ナラティブの共同執筆は Google ドキュメントを使いオンラインで行う"  />
<p class="caption">(\#fig:trakdown1)trackdown の作業工程, コードの共同執筆は Git を使いローカルで行い,  ナラティブの共同執筆は Google ドキュメントを使いオンラインで行う</p>
</div>
